...
import myapplication.android.pixelpal.databinding.DialogLogoutWarningBinding
import myapplication.android.pixelpal.ui.listener.DialogDismissedListener

class LogoutWarningDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val binding = DialogLogoutWarningBinding.inflate(layoutInflater)
    ...
    override fun onDismiss(dialog: DialogInterface) {
        ...
        if (logout) dialogDismissedListener?.handleDialogClose()
    }
